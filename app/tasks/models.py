...
class Tasks(db.Model, CRUD_MixIn):
    ...
    finished_size = db.Column(db.Integer, nullable=False)
    task_operate = db.Column(db.String(20), nullable=False)
    modify_user = db.Column(db.String(32), nullable=False)

    def __init__(self, task_id, task_code, task_size, task_operate, modify_user, finished_size=0):
        self.id = task_id
...
class TasksSchema(Schema):
    ...
    finished_size = fields.Integer(validate=not_blank)
